...
// NOTE: the code is kept OUT of the subject line — a bare code in the subject
// is a classic phishing pattern that Microsoft 365 / Outlook quarantines.
export async function sendCodeEmail(toEmail, code) {
  ...
  const text =
    ...
    `Enter the code above to unlock the full library. It is valid for about 30 minutes.\n\n` +
    `If you didn't request this, you can ignore this email.`;
  const html = `
  <div style="font:16px/1.5 -apple-system,Segoe UI,Roboto,sans-serif;color:#232a31;max-width:480px;margin:auto">
    <h2 style="color:#1F3A5F;margin:0 0 6px">Your sign-in code</h2>
    ...
    <p style="margin:14px 0 0;color:#6b7783;font-size:13px">Valid for about 30 minutes. Didn't request it? Ignore this email.</p>
  </div>`;
